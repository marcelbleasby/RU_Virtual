...
// Any custom colors not part of the Material 3 palette can be defined here.
// For example, if VirtualCardBackground or GreenSuccess are custom and not part of the M3 scheme.
val VirtualCardBackground = Color(0xFF4A3780) // Example custom color
val GreenSuccess = Color(0xFF388E3C) // Example custom color
